...
.factory('Category', function() {
	  ...
	  // Some fake testing data
	  var categories = [
{id:1,name:'个护化妆',level:1,parentID:0,icon:'icon-gehuhuazhuang02'},
...
{id:36,name:'珠宝饰品',level:1,parentID:0,icon:'icon-tubiao'},
...
{id:96,name:'鞋靴',level:1,parentID:0,icon:'icon-fuzhuangxiexue01'},
...
{id:114,name:'皮革箱包',level:1,parentID:0,icon:'icon-icon16258'},
...
{id:193,name:'体育用品',level:1,parentID:0,icon:'icon-tiyu02'},
